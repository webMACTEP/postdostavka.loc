...
function sp_scripts()
{
	...
	wp_enqueue_style('myselect', get_template_directory_uri() . '/css/select.css');
	...
	//wp_enqueue_script('select', get_template_directory_uri() . '/js/select.js');
